...
:mod:`blendertk.mat_utils.marmoset_bridge._marmoset_engine` inside the same
parent subpackage (mirror of mayatk's identically-shaped subpackage). The
two share Toolbag knowledge but have opposite trade-offs:
...
Usage::
    ...
    from blendertk.mat_utils.marmoset_bridge.marmoset_rpc import (
        MarmosetConnection,
    )
