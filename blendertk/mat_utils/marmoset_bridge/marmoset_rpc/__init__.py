...
:mod:`blendertk.mat_utils.marmoset_bridge` (mirror of mayatk's identically-shaped
subpackage). Both share the same parent subpackage so the two trade-offs sit side
by side:
