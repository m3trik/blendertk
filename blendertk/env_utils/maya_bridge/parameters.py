...
PARAMS: "dict[str, AttributeSpec]" = {
    ...
    "INCLUDE_SHOTS": AttributeSpec(
        ...
        tooltip=(
            "Carry the scene's shots across so Maya's Shot Sequencer shows the same\n"
            ...
            "(the same manifest the materials and Empties ride). Memberships are scoped\n"
            "to what is sent; the shots themselves always cross. A scene that already has\n"
