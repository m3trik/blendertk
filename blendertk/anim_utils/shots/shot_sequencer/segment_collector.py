...
class SegmentCollector:
    ...
    def collect_segments(
        ...
        all_objects: set = set()
        pinned = (
            sequencer.store.pinned_objects if sequencer and sequencer.store else set()
        )
        ...
        if shifted_out_keys:
            ...
            for seg in active_segs:
                ...
                if (
                    ...
                    and t is not None
                    and any(
                        abs(t - ex) < KEY_PROXIMITY_EPS for ex in shifted_out_keys[obj]
                    )
                ):
                    logger.debug(
