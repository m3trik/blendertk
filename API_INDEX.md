...
### `core_utils/diagnostics/scene_audit.py` — Scene audit -- the Blender port of mayatk's ``core_utils.diagnostics.scene_audit``.
- `class SceneInfoSection`
  - methods: normalize
- `class SceneAnalyzer`
  - methods: format_audit_html, format_audit_text
